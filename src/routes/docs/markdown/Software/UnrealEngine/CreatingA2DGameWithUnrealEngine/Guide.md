...
![FabImage](/docsStatic/CreatingA2DGameWithUnrealEngine/Images/FabShowcase.png)
...
![FabImage](/docsStatic/CreatingA2DGameWithUnrealEngine/Gifs/PaperZDInstall.gif)
...
![EnablePaperZD](/docsStatic/CreatingA2DGameWithUnrealEngine/Gifs/PaperZDEnable.gif)
...
![FolderLayout](/docsStatic/CreatingA2DGameWithUnrealEngine/Images/FolderLayout.png)
...
![RedHoodInstall](/docsStatic/CreatingA2DGameWithUnrealEngine/Images/RedHoodInstall.png)
...
![ImportRedHood](/docsStatic/CreatingA2DGameWithUnrealEngine/Gifs/ImportRedHood.gif)
...
![ChangingTextureGroup](/docsStatic/CreatingA2DGameWithUnrealEngine/Images/ChangingTextureGroup.png)
...
![ChangingTextureGroup](/docsStatic/CreatingA2DGameWithUnrealEngine/Gifs/BulkEditInPropertyMatrix.gif)
...
![ChangeCompressionSettings](/docsStatic/CreatingA2DGameWithUnrealEngine/Images/ChangeCompressionSettings.png)
...
![RedHoodFolderStructure](/docsStatic/CreatingA2DGameWithUnrealEngine/Images/FolderStructure.png)

Then we can go ahead, click and drop each Texture map into its respective folder as follows

![RedHoodFolderStructure](/docsStatic/CreatingA2DGameWithUnrealEngine/Gifs/ShiftingToFolders.gif)
...
![Extract Sprites](/docsStatic/CreatingA2DGameWithUnrealEngine/Images/ExtractSprites.png)

Now a window like this should pop up

![ExtractSprites](/docsStatic/CreatingA2DGameWithUnrealEngine/Images/ExtractSprites1.png)
...
![ChangeWidthLength](/docsStatic/CreatingA2DGameWithUnrealEngine/Gifs/ChangeWidthLength.gif)

By doing this we convert a sprite sheet into individual sprites, where each sprite is a frame in the animation

![RedHoodSprites](/docsStatic/CreatingA2DGameWithUnrealEngine/Images/RedHoodSprites.png)
