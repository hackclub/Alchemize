		...
		>
			<div class="flex items-center gap-4">
				<img
					alt="Profile Picture"
					src={data.pfp}
					class="border-2 border-primary bg-black w-12 h-12 rounded-none shadow-[2px_2px_0px_0px_rgba(var(--primary),0.3)]"
				/>
				<div>
					<h1
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start w-full">
			<div class="flex flex-col gap-6 w-full h-full">
				<div class="gap-6 grid grid-cols-1 sm:grid-cols-2 w-full">
					<div class="relative group">
						<div
							class="absolute inset-0 bg-primary/20 translate-x-[4px] translate-y-[4px] rounded-none"
						></div>
						<div
							class="relative flex flex-col gap-2 bg-black border-2 border-primary/80 p-4 rounded-none"
						>
							<p
				...
				<div class="relative w-full h-full">
					<div
						class="absolute inset-0 bg-primary/40 translate-x-[6px] translate-y-[6px] rounded-none"
					></div>
					<div
						class="relative flex flex-col gap-4 bg-black border-2 border-primary p-5 rounded-none h-full"
					>
						<h2
						...
						<div class="flex flex-col flex-1 gap-3 overflow-y-auto pr-1">
							{#each projects as project}
								<div
									class="bg-zinc-950 border border-primary/30 p-4 rounded-none hover:border-primary/70 transition-colors cursor-pointer flex flex-col justify-between gap-2 group/item"
								>
			...
			<div class="flex flex-col gap-6 w-full h-full">
				<div class="relative w-full">
					...
					></div>
					<div
						class="relative flex flex-col gap-4 bg-black border-2 border-primary p-5 rounded-none"
					>
						<h2
							class="font-alchemize font-black text-primary text-lg uppercase tracking-wider"
						>
						...
						<div class="flex gap-x-4 w-full h-full">
							<div class="gap-4 grid grid-cols-2 w-full">
								<a
									href="/dashboard/projects"
									class="flex flex-col justify-center items-center gap-2 bg-zinc-950 border-2 border-primary/40 p-4 rounded-none text-zinc-300 hover:text-primary hover:border-primary hover:bg-primary/5 transition-all shadow-[2px_2px_0px_0px_rgba(var(--primary),0.15)] active:translate-x-0.5 active:translate-y-0.5"
								>
							...
							{#if data.admin || true}
								<a
									href="/admin"
									class="flex flex-col justify-center items-center gap-2 bg-zinc-950 border-2 border-primary/40 p-4 rounded-none text-zinc-300 hover:text-primary hover:border-primary hover:bg-primary/5 transition-all shadow-[2px_2px_0px_0px_rgba(var(--primary),0.15)] active:translate-x-0.5 active:translate-y-0.5 grid-cols-1"
								>
				...
				<div class="relative w-full">
					...
					>
						...
						<div class="gap-4 grid grid-cols-2">
							<div
								class="flex items-center gap-3 bg-zinc-950 border border-primary/20 p-3 rounded-none"
							>
								<div class="bg-black p-1.5 border border-primary/30 shrink-0">
									<img
